<header>
    ...
    <div class="headClass">
        <div class="navbar">
            <span>
                <a href="#"><img src="../../img/jabalogo.svg" alt=""></a>
            </span>
            <span>
        ...
        <div class="headerMain">
            <h1>My name is Javidan Babayev, I'm web developer and UI/UX desinger</h1>
            <a href="#">
        ...
        <p style="text-align: center; font-size:2vw;">Diqqətinizə çatdırıram ki, sayt tam hazır deyil</p>
    </div>
</header>